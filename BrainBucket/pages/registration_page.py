...
from BrainBucket.webelements.UIElement import UIElement as Element, UIElement
...
class RegistrationPage:
    ...
    def __init__(self, browser):
        ...
        self.phone_number_error = Element(browser, By.XPATH, "//fieldset[@id='account']/div[5]/div/div")
        self.password_error = Element(browser, By.XPATH, "//fieldset[3]/div/div/div")
        self.email_error = Element(browser, By.XPATH, "//div[contains(text(),'E-Mail Address does not appear to be valid!')]")
        self.address_error = Element(browser, By.XPATH, "//div[contains(text(),'Address 1 must be between 3 and 128 characters!')]")
        self.city_error = Element(browser, By.XPATH, "//div[contains(text(),'City must be between 2 and 128 characters!')]")
    ...
    def get_phone_number_error(self):
        return self.phone_number_error.get_text()
